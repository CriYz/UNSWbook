...
<%
    ...
    if (!userlist.isEmpty()){
        out.print("<table class='table' cellpadding='0' cellspacing='0' border='0'><tr class='tbl-header'><td>username</td><td>password</td><td>email</td><td>gender</td><td>dob</td><td>name</td><td>photo</td><td>ban</td><td>Active</td><td>Action</td></tr>");
